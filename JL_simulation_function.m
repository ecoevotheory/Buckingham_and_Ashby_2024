function [tolJ_end,alpha_end,end_pop,strain_totalH,strain_totalP,indexH_end,indexP_end,TOLJ,ALPHAJ,DISPREV,NVEC] = JL_simulation_function(t_max,a0,g,q,beta0,c1,c2,tA,rJ,rA,tolJmin,tolJmax,tolJ_start,alphamin,alphamax,alpha_start,f,bJ,bA,gamma,hostmutationprob,init_pop,strain_totalH,strain_totalP,indexH_start,indexP_start,res0,nevol)
...
for ievol=1:nevol
    ...
    [~,SJ1,SA1,IJ1,IA1,~] = JL_eco_dynamics_function(t_max,a0,g,q,c1,c2,rJ,rA,tA,tolJ_current,alpha_current,f,bJ,bA,beta0,gamma,eqtol,init_pop,strain_totalH,strain_totalP);
    ...
    % If the mutation occurs in the parasite virulence:
        ...
        if(~ismember(mutant,indexP_current)) % New strain
            ...
            alpha_current_again(1,end)=AlphaJ(mutant);
