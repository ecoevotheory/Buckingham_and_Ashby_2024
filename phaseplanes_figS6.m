...
ax=gca;
ax.FontSize=14;
xlabel('Juvenile tolerance, $\tau_J$','interpreter','latex','fontsize',16)
...
hostmutationprob=0.5;
fin_P=40;
[trajH3,trajP3]=JL_sim_traj_function(tolstart,alphastart,q,f,bJ,g,bA,tA,beta0,rJ,rA,a0,c1,c2,gamma,startH,startP,finH,fin_P,nevol,hostmutationprob);
trajP3=trajP3/finP;
deletevec=zeros(nevol,1);
for i=1:nevol
