...
plot(2.5+zeros(100,1),linspace(0,1,100),':k','linewidth',2)
plot(4.5+zeros(100,1),linspace(0,1,100),':k','linewidth',2)
...
% Plot where the lifespan gets too low to sustain the host population:
plot(2.5+zeros(100,1),linspace(0,finP,100),':k','linewidth',2)
plot(4.5+zeros(100,1),linspace(0,finP,100),':k','linewidth',2)
